...
???
OK, set up, we have a struct for payments, an event for when payments are executed, a mapping to store the payments, and a constructor that just sets all the initial values.
